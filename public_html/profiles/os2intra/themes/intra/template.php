 ...
 */
function intra_preprocess_html(&$variables) {
 ...
 */
function intra_preprocess_node(&$variables) {
 ...
 */
function intra_preprocess_comment(&$variables) {
 ...
 */
function intra_node_view_alter(&$build) {
 ...
 */
function intra_preprocess_node__full(&$variables) {
}
 ...
 * Implements hook_preprocess_node().
 */
function intra_preprocess_node__event(&$variables) {
  $node = $variables['node'];
 ...
 * Implements hook_preprocess_node().
 */
function intra_preprocess_node__post(&$variables) {
  $node = $variables['node'];
 ...
 * Implements hook_preprocess_node().
 */
function intra_preprocess_node__spotbox(&$variables) {
 ...
 * Implements hook_preprocess_node().
 */
function intra_preprocess_node__os2intra_base_page(&$variables) {
 ...
 * Implements hook_preprocess_node().
 */
function intra_preprocess_node__it_vejledning(&$variables) {
  if ($variables['view_mode'] == 'full') {
    $variables['sections'] = views_embed_view('os2intra_node_panes', array('panel_pane_7'));
  }
}
 ...
 * Implements hook_preprocess_node().
 */
function intra_preprocess_node__wiki(&$variables) {
  if ($variables['view_mode'] == 'full') {
    $variables['sections'] = views_embed_view('os2intra_node_panes', array('panel_pane_7'));
  }
}
 ...
 * Implements hook_preprocess_node().
 */
function intra_preprocess_node__node_basket(&$variables) {
...
function intra_theme(&$existing, $type, $theme, $path) {
  $hooks = array();
 ...
 */
function intra_preprocess_taxonomy_term(&$variables) {
  $term = $variables['term'];
 ...
 * Implements template_preprocess_taxonomy_term().
 */
function intra_preprocess_taxonomy_term__os2web_taxonomies_tax_places(&$variables) {
  $term = $variables['term'];
 ...
 */
function intra_preprocess_field(&$variables, $hook) {
 ...
 */
function intra_preprocess_user_profile(&$variables) {
 ...
 */
function intra_form_alter(array &$form, array &$form_state = array(), $form_id = NULL) {
  if ($form_id) {
    switch ($form_id) {
...
function intra_main_navigation_search_form($variables) {
